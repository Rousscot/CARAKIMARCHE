    ...
    <div style=" display: flex; justify-content: space-between;">
        <div style="width: 30%; border-right: solid 1px grey;">
            ...
            <form Method="POST" Action="souscrire">
                ...
                <br>
                <br>
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--primary" type="submit" value="Créer" name="action:SubscribeHouseContract">
                    Ajouter
                </button>
            </form>
        </div>
        <div style="width: 30%; border-right: solid 1px grey;">
            ...
            <form Method="POST" Action="souscrire">
                ...
                <br>
                <br>
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--primary" type="submit" value="Créer" name="action:SubscribeLifeContract">
                    Ajouter
                </button>
            </form>
        </div>
        <div style="width: 30%;">
            ...
            <form Method="POST" Action="souscrire">
                ...
                <br>
                <br>
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--primary" type="submit" value="Créer" name="action:SubscribeCarContract">
                    Ajouter
                </button>
            </form>
        </div>
